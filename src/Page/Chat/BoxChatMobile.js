...
function BoxChatMobile({ appUserConversation, reloadRef, seen , onBack , onFetchData, handleFetchConversation }) {
  ...
  return (
    <Col
      ...
      xs={{ span: 24 }}
    >
      <div className='box__chat boxMobile__chat'>
        <Row>
          <Col
          ...
          >
            <div className='box__chat__wrap'>
              <div className='box__chat__header px-3 pt-2'>
                <div className='box__chat__back d-flex' onClick={onBack}>
...
export default memo(BoxChatMobile);